...
def is_valid_date(input_string):
    ...
    date_formats = [
        r'(([0-2])?[0-8]|19)[./-]2[./-]\d{4}', # день.месяц.год 
        r'(([0-2])?[0-9]|30)[./-](?:4|6|9|11)[./-]\d{4}',
        r'(([0-2])?([0-9]|30|31))[./-](?:1|3|5|7|8|10|12)[./-]\d{4}',
        
        r'\d{4}[./-]2[./-](([0-2])?[0-8]|19)', # год.месяц.день
        r'\d{4}[./-](?:4|6|9|11)[./-](([0-2])?[0-9]|30)',
        r'\d{4}[./-](?:1|3|5|7|8|10|12)[./-](([0-2])?[0-9]|30|31)',
